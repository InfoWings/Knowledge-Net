...
val MeasureDesc: Map<String, String> = mapOf(
    ...
    "Tesla" to "The tesla (symbol T) is a derived unit of magnetic flux density (informally, magnetic field strength) in the International System of Units.",
...
val MeasureMesureGrupMap = MeasureGroupMap.values.flatMap { group -> group.measureList.map { it.name to group } }.toMap()
