...
class SpeedConverterTest {
    ...
    private fun toMetrePerSecondTest(source: Double, sourceInMetrePerSecond: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInMetrePerSecond, measure, SpeedGroup.base)
}