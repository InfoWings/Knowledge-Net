...
class TimeConverterTest {
    ...
    private fun toSecondsMeasureTest(source: Double, sourceInSeconds: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInSeconds, measure, TimeGroup.base)
}