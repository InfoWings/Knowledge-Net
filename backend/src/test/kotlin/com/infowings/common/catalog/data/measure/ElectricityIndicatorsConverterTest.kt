...
class ElectricityIndicatorsConverterTest {
    ...
    private fun toWattTest(source: Double, sourceInWatt: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInWatt, measure, PowerEnergyGroup.base)
    ...
    private fun toJouleTest(source: Double, sourceInJoule: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInJoule, measure, WorkEnergyGroup.base)
}