...
class AreaAndVolumeConverterTest {
    ...
    private fun toSquareMetreTest(source: Double, sourceInSquareMetre: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInSquareMetre, measure, AreaGroup.base)

    private fun toCubicMetreTest(source: Double, sourceInSquareMetre: Double, measure: Measure<DecimalNumber>) = measureTest(source, sourceInSquareMetre, measure, VolumeGroup.base)
}