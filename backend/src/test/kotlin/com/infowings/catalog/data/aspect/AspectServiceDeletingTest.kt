...
class AspectServiceDeletingTest {
    ...
    fun testDeleteAspectWithObjectValue() {
        ...
        val propId = objectService.create(PropertyCreateRequest(objectId, "prop", aspectId), username)
    ...
    fun testDeleteHasValue() {
        ...
        objectService.create(PropertyCreateRequest(obj, "prop", aspectWithObjectProperty.id!!), username)
